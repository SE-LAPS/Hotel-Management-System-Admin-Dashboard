...
<body>
   <main class="bg-sign-in d-flex justify-content-center align-items-center">
      <div class=" form-sign-in bg-white mt-2 h-auto mb-2 text-center pt-2 pe-4 ps-4 d-flex flex-column">
        <h1 class="E-classe text-start ms-3 ps-1" ><b>HOTEL ADMIN</b></h1>
        <div>
        ...
        <?php
        // Check if the 'error' parameter is set in the URL query string
          if(isset($_GET['error'])){

            // Check different error conditions and display corresponding alert messages
    ...
    <label class="form-check-label" for="exampleCheck1">Remember Me</label>
        ...
        <button href="" class="btn-register btn btn-success mb-3 custom-btn-color">Create Account</button>
